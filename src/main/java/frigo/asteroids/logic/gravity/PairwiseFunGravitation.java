...
public class PairwiseFunGravitation {
    ...
    public PairwiseFunGravitation (Entity attractor, Entity attracted) {
        ...
        r2 = Math.sqrt(direction.x * direction.x + direction.y * direction.y);
        if( r2 <= 0.0 ){
