...
public class PositionTest {
    ...
    public void too_low_coordinates_are_wrapped () {
        ...
        assertThat(position.x, is(-1.0));
        assertThat(position.y, is(-1.0));
    }

    @Test
    public void too_high_coordinate_are_wrapped () {
        Position position = new Position(8.5, 10.5);
        assertThat(position.x, is(0.5));
        assertThat(position.y, is(0.5));
    }
    ...
    public void coordinates_are_added_properly () {
        ...
        assertThat(position.x, is(0.6));
        assertThat(position.y, is(0.4));
    }
